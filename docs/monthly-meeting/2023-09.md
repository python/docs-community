...
- [Hugo] https://docs.python.org now has a dark theme! 🌒 
...
- [CAM] Quick update on reStructured Data
  ...
  - Learn more
    - [HackMD detailed design document and schema](https://hackmd.io/jF8awEd3TuKh1Ia5Hqa_8g?both#TransformsProcessors)
