...
- Ezio, core Dev, working on Docs and infrastucture
...
* [PyCon](https://us.pycon.org/2023/), April 19-27 2023:
  ...
  * Sprints: [Hugo] switched CPython docs previews from Netlify to RtD.
    ...
    * https://github.com/python/cpython/pull/103843
* GH action to update the link from the PR - we don't need one for Netlify
    ...
    * Example of preview link: Pull Request [#104013, **gh-104010: Separate and improve docs for typing.get_origin and typing.get_args**](https://github.com/python/cpython/pull/104013), contains a link to a preview of the documentation reflecting the Pull Request's effects, at https://cpython-previews--104013.org.readthedocs.build/en/104013/ .
...
https://github.com/python/peps/pull/3132
